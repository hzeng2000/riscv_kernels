#!/bin/bash
# Auto-generated build script for quantize_row_q8_0 on sg2044
# RVV Version: rvv_1.0
# Supports: O1/O3 optimization levels, local/cross compilation, static/dynamic linking

set -e

KERNEL_NAME="quantize_row_q8_0"
KERNEL_KEY="quantize"
HW_NAME="sg2044"
MARCH="rv64gcv"
...
echo "=========================================="
echo "Building quantize_row_q8_0 benchmark for sg2044"
echo "=========================================="
echo ""
...
echo ""
echo "Run examples:"
echo "  ./static_test_runner_quantize_cross_O3.out -n 4096 -r 1000    # static linked"
echo "  ./test_runner_quantize_cross_O3.out -n 4096 -r 1000           # dynamic linked"
