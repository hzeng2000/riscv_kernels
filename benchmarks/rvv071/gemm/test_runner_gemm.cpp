...
struct TestEntry {
    std::string name;
    ggml_gemm_q4_0_8x8_q8_0_t func;
};
...
int main(int argc, char** argv) {
    ...
    if (config.tests_to_run["all"] || config.tests_to_run["asm"]) {
        all_tests.push_back({"Asm Unroll=1 Serial", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll1_serial});
        all_tests.push_back({"Asm Unroll=1 Pipe", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll1_pipelined});
        all_tests.push_back({"Asm Unroll=1 fused", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll1_fused});
        all_tests.push_back({"Asm Unroll=2 Serial", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll2_serial});
        all_tests.push_back({"Asm Unroll=2 fused", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll2_fused});
        all_tests.push_back({"Asm Unroll=2 Pipe", ggml_gemm_q4_0_8x8_q8_0_rvv_asm_unroll2_pipelined});
        all_tests.push_back({"Asm auto generated", ggml_gemm_q4_0_8x8_q8_0_asm_auto_generated});
    }
#endif
