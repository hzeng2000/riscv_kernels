#!/bin/bash
# Auto-generated build script for ggml_gemm_q4_0_8x8_q8_0 on th1520
# RVV Version: rvv_0.7.1
# Supports: O1/O3 optimization levels, local/cross compilation, static/dynamic linking

set -e

KERNEL_NAME="ggml_gemm_q4_0_8x8_q8_0"
KERNEL_KEY="ggml_gemm_q4_0_8x8_q8_0"
HW_NAME="th1520"
...
echo "=========================================="
echo "Building ggml_gemm_q4_0_8x8_q8_0 benchmark for th1520"
echo "=========================================="
echo ""
...
echo ""
echo "Run examples:"
echo "  ./static_test_runner_ggml_gemm_q4_0_8x8_q8_0_cross_O3.out -n 4096 -r 1000    # static linked"
echo "  ./test_runner_ggml_gemm_q4_0_8x8_q8_0_cross_O3.out -n 4096 -r 1000           # dynamic linked"
