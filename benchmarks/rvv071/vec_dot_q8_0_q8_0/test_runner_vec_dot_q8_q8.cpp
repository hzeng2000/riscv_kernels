...
// Auto-generated test runner for ggml_vec_dot_q8_0_q8_0 on th1520
...
std::string short_name(const std::string& full_name) {
    const std::string prefix = "ggml_vec_dot_q8_0_q8_0_";
...
int main(int argc, char** argv) {
    ...
    std::cout << "=== ggml_vec_dot_q8_0_q8_0 Benchmark on th1520 ===" << std::endl;
    ...
    ggml_vec_dot_q8_0_q8_0_scalar(config.n, &baseline_result, x_q8_0.data(), y_q8_0.data());
